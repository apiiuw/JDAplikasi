...
public class PopularCategoryParkActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_popular_category_park);

        RelativeLayout parkTamanSafariBahari = findViewById(R.id.popular_category_1);
        RelativeLayout parkKomodoNational = findViewById(R.id.popular_category_2);
        RelativeLayout parkBunakenNationalMarine = findViewById(R.id.popular_category_3);
        ...
        // Reference for title
        DatabaseReference titleRef = database.getReference("popular_category/park/judul");
        ...
        for (int i = 0; i < 4; i++) {
            ...
            dataImageRefs[i] = database.getReference("popular_category/park/data" + index + "/image");
            dataNameRefs[i] = database.getReference("popular_category/park/data" + index + "/nama");
            dataLocationRefs[i] = database.getReference("popular_category/park/data" + index + "/lokasi");
        }
        ...
        for (int i = 0; i < 4; i++) {
            ...
            dataImageRefs[i].addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    Glide.with(PopularCategoryParkActivity.this)
                            .load(imageUrl)
                            .into(imageView);
                }
