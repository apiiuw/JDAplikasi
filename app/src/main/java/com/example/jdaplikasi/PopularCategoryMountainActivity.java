...
public class PopularCategoryMountainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Reference for title
        DatabaseReference titleRef = database.getReference("popular_category/mountain/judul");
        ...
        for (int i = 0; i < 5; i++) {
            ...
            dataImageRefs[i] = database.getReference("popular_category/mountain/data" + index + "/image");
            dataNameRefs[i] = database.getReference("popular_category/mountain/data" + index + "/nama");
            dataLocationRefs[i] = database.getReference("popular_category/mountain/data" + index + "/lokasi");
        }
        ...
        for (int i = 0; i < 5; i++) {
            ...
            dataImageRefs[i].addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    Glide.with(PopularCategoryMountainActivity.this)
                            .load(imageUrl)
                            .into(imageView);
                }
