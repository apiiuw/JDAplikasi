...
public class PopularCategoryBeachActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Reference for title
        DatabaseReference titleRef = database.getReference("popular_category/beach/judul");
        ...
        for (int i = 0; i < 5; i++) {
            ...
            dataImageRefs[i] = database.getReference("popular_category/beach/data" + index + "/image");
            dataNameRefs[i] = database.getReference("popular_category/beach/data" + index + "/nama");
            dataLocationRefs[i] = database.getReference("popular_category/beach/data" + index + "/lokasi");
        }
        ...
        for (int i = 0; i < 5; i++) {
            ...
            dataImageRefs[i].addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    Glide.with(PopularCategoryBeachActivity.this)
                            .load(imageUrl)
                            .into(imageView);
                }
